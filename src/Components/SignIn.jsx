...
const SignIn = () => {
  ...
  useEffect(() => {
    axios
      .get('https://passwordrestflow-backend.onrender.com/api/v1/userInfo', { withCredentials: true })
      .then(() => {
  ...
  const handleLogin = (e) => {
    ...
    axios
      .post(
        'https://passwordrestflow-backend.onrender.com/api/v1/login',
        { email, password },
      ...
      .then((response) => {
        ...
        navigate('/PasswordReset'); // Redirect to UserInfo page
      })
      .catch((error) => {
